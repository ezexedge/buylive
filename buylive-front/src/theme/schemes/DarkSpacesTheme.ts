import { alpha, createMuiTheme, darken } from '@material-ui/core';
...
const colors = {
  gradients: {
    ...
    black1: 'linear-gradient(100.66deg, #2B304D 6.56%, #393939 93.57%)'
  },
  shadows: {
    success:
...
export const DarkSpacesTheme = createMuiTheme({
  // direction: i18n.dir(),
  colors: {
    gradients: {
