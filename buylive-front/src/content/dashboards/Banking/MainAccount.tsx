...
const TypographySucccess = experimentalStyled(Typography)(
  ({ theme }) => `
...
const BankLogoImg = experimentalStyled('img')(
  ({ theme }) => `
      position: absolute;
      opacity: .15;
      width: 200px;
...
function MainAccount() {
  ...
  return (
    <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <CardHeader
        sx={{ px: 3, pt: 3, alignItems: 'flex-start' }}
        action={
          <>
      ...
      />
      <CardContentWrapper sx={{ px: 3, pt: 4, pb: 5 }}>
        <Hidden lgDown>
      ...
      <CardActionsWrapper sx={{ p: 3, height: '100%', flex: 1 }}>
