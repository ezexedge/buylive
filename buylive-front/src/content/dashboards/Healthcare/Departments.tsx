...
const DepartmentsChartWrapper = experimentalStyled(DepartmentsChart)(
  ({ theme }) => `
    width: 90px;
`
);

const BoxChartWrapper = experimentalStyled(Box)(
  ({ theme }) => `
    display: flex;
    align-items: center;
    ...
    <Card sx={{ height: '100%' }}>
      ...
      <Box py={3}>
        <Grid container spacing={0} justifyContent="center" alignItems="center">
          ...
          <Grid xs={12} sm={4} sx={{ position: 'relative' }} item>
            <Hidden smDown>
