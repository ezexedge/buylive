...
import MedicalServicesTwoToneIcon from '@material-ui/icons/MedicalServicesTwoTone';

const AppointmentsAltChartWrapper = experimentalStyled(AppointmentsAltChart)(
  ({ theme }) => `
        height: 90px;
        width: 200px;
`
