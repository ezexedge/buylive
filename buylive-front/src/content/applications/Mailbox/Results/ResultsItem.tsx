...
const IconButtonLabel = experimentalStyled(Box)(
  ({ theme }) => `
    display: flex;
...
const MailboxItemWrapper = experimentalStyled(Box)(
  ({ theme }) => `
    align-items: center;
...
const ResultsItem: FC<ResultsItemProps> = ({
  ...
  return (
    ...
    >
      ...
      <Box
        sx={{ flex: 1, alignItems: 'center', display: { md: 'flex' } }}
