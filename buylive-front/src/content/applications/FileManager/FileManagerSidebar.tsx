...
const WarningTwoToneIconWrapper = experimentalStyled(WarningTwoToneIcon)(
  ({ theme }) => `
    color: ${theme.colors.warning.main};
`
);

const ButtonContrast = experimentalStyled(Button)(
  ({ theme }) => `
  ...
  return (
    <Box>
      <Box sx={{ p: { xs: 2, lg: 4 } }}>
        ...
        <BoxUpgrade sx={{ p: 3, mt: 4 }}>
          <Box pr={17}>
            <TypographyPrimary variant="h2" sx={{ pb: 1 }}>
              {t('Get more space now')}!
            </TypographyPrimary>
            <TypographySecondary variant="subtitle2" sx={{ pb: 3, pr: 2 }}>
